<%-- 
    Document   : footer
    Created on : Mar 5, 2022, 11:25:37 PM
    Author     : Admin
--%>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  ...
                  <ul class="aa-footer-nav">
                    ...
                    <li><p style="color:#888; text-align: justify; width: 95%">Là nơi chuyên buôn bán tất cả các mặt hàng về đồ cũ chất lượng. Chúng tôi luôn đặt tiêu chí về chất lượng và uy tín lên hàng đầu.</p></li>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>LIÊN HỆ</h3>
                    <address>
                      <p>328 Nguyễn Trãi - Q.Thanh Xuân - Hà Nội</p>
                      <p><span class="fa fa-phone"></span>0948.135.126</p>
                      <p><span class="fa fa-envelope"></span>webdocu@gmail.com</p>
                    </address>
