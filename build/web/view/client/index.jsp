<%-- 
    Document   : index
    Created on : Mar 5, 2022, 10:57:00 PM
    Author     : Admin
--%>
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="" data-toggle="tab">Điện dân dụng</a></li>
                    <li><a href="" data-toggle="tab">Thời Trang</a></li>
                    <li><a href="" data-toggle="tab">Sách</a></li>
                    <li><a href="" data-toggle="tab">Phương Tiện</a></li>
                  </ul>
                  <!-- Tab panes -->
